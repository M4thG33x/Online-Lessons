...
const SiteMap = [
    ...
    { courseFolder: "calciii", file: "angles.html", pageName: "Angles", lessonName: "Vectors and Geometry in Space" },
    { courseFolder: "calciii", file: "2dspace.html", pageName: "2D Space", lessonName: "Vectors and Geometry in Space" },
    { courseFolder: "calciii", file: "3dspace.html", pageName: "3D Space", lessonName: "Vectors and Geometry in Space" }  // Shared lessonName
];
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (indexContainer) {
        // Render the main home dashboard directory index ONLY if on the root page
        buildCourseIndexDirectory(indexContainer);
    } else {
        // Otherwise, render standard navigation rows inside flat course folder files
        loadStickyTopNav();
...
function loadStickyTopNav() {
    ...
    html += `<div class="nav-search-container">
                <input type="search" id="coursesearch" class="search-input-field" placeholder="Search this course..." aria-label="Search pages in this course">
...
// =====================================================================================
// 6. Print Utility and Example Visibility Toggle
// =====================================================================================
...
// =====================================================================================
// 7. Click-to-Reveal Example Solution Toggle Utility
// =====================================================================================
